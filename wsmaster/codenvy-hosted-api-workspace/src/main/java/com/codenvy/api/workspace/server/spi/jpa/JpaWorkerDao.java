...
public class JpaWorkerDao extends AbstractJpaPermissionsDao<WorkerImpl> implements WorkerDao {
    ...
    @Singleton
    public static class RemoveWorkersBeforeWorkspaceRemovedEventSubscriber extends CancelableEventSubscriber<BeforeWorkspaceRemovedEvent> {
        ...
        @Override
        public void onCancelableEvent(BeforeWorkspaceRemovedEvent event) throws Exception {
    ...
    @Singleton
    public static class RemoveWorkersBeforeUserRemovedEventSubscriber extends CancelableEventSubscriber<BeforeUserRemovedEvent> {
        @Inject
        private EventService eventService;
        @Inject
        ...
        @Override
        public void onCancelableEvent(BeforeUserRemovedEvent event) throws Exception {
