...
public class JpaStackPermissionsDao extends AbstractJpaPermissionsDao<StackPermissionsImpl> {
    ...
    @Singleton
    public static class RemovePermissionsBeforeStackRemovedEventSubscriber extends CancelableEventSubscriber<BeforeStackRemovedEvent> {
        ...
        @Override
        public void onCancelableEvent(BeforeStackRemovedEvent event) throws Exception {
